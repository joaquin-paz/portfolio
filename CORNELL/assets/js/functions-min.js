!function(t, e, i, n) {
    ...
    var yt = a(function we(t, e, i) {
        ...
        At = "touch", Dt = "pen", _t = "mouse", St = "kinect", bt = 25,
        Pt = 1, Ot = 2, Rt = 4, Mt = 8,
        zt = 1, Nt = 2, Xt = 4, Yt = 8, kt = 16,
        qt = Nt | Xt, Ft = Yt | kt, Wt = qt | Ft,
        Ht = ["x", "y"], Lt = ["clientX", "clientY"];
    ...
    var Vt = {
        ...
        Ut = "mousedown", jt = "mousemove mouseup";
    ...
    l(Y, I, {
        handler: function De(t) {
            ...
            e & Ot && 1 !== t.which && (e = Rt),
            this.pressed && (e & Rt && (this.pressed = !1), this.callback(this.manager, e, {
                pointers: [t],
                changedPointers: [t],
                pointerType: _t,
                srcEvent: t
    ...
    l(st, J, {
        ...
        process: function(t) {
            ...
            if (this._input = t, !n || !i || t.eventType & (Rt | Mt) && !s) this.reset();
    ...
    l(at, J, {
        ...
        process: function(t) {
            ...
            if (n && s && i) {
                ...
                this.pTime = t.timeStamp, this.pCenter = t.center, o && r ? this.count += 1 : this.count = 1, this._input = t;
                var a = this.count % e.taps;
                if (0 === a) return this.hasRequireFailures() ? (this._timer = s(function() {
                    this.state = Te, this.tryEmit();
    ...
    function t(t) {
        ...
        if ("swipeup" === t.type || 40 === t.keyCode || t > 0) {
            s !== r ? (o = s + 1, e(o), i(s, o, r)) : (e(o), i(s, o, r));
        } else if ("swipedown" === t.type || 38 === t.keyCode || 0 > t) {
            s !== 0 ? (o = s - 1, e(o), i(s, o, r)) : (o = r, e(o), i(s, o, r));
        }
    }
